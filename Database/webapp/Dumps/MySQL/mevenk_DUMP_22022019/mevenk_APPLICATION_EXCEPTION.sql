...
--
-- Dumping data for table `APPLICATION_EXCEPTION`
--

LOCK TABLES `APPLICATION_EXCEPTION` WRITE;
/*!40000 ALTER TABLE `APPLICATION_EXCEPTION` DISABLE KEYS */;
/*!40000 ALTER TABLE `APPLICATION_EXCEPTION` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-02-22 22:38:01
